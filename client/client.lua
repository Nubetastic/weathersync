...
RegisterNetEvent("weathersync:printForecast")
AddEventHandler("weathersync:printForecast", function(regionName, forecast)
    if not forecast then
        print("^1[FORECAST]^7 No weather data for region: " .. regionName)
        return
    end
